...
{
    /// <summary>
    /// This is the MotoTrak error logging service.  It logs errors out to a file when they are detected.
    /// </summary>
    public class ErrorLoggingService
    {
        ...
        public void LogExceptionError(Exception e)
        {
            lock (_error_log_lock)
            {
                ...
                {
                    MotoTrakMessaging.GetInstance().AddMessage("Unable to log error to file");
                }
            }
        }
