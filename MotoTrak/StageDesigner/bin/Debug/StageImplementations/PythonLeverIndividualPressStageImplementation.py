...
class PythonLeverIndividualPressStageImplementation (IMotorStageImplementation):
    ...
    def AdjustBeginningStageParameters(self, recent_behavior_sessions, current_session_stage):
        ...
        if stage.StageParameters.ContainsKey(nth_feed_parameter):
            PythonLeverIndividualPressStageImplementation.nth_feed_parameter_value = stage.StageParameters[nth_feed_parameter].CurrentValue
                ...
                if (PythonLeverIndividualPressStageImplementation.press_state == 0):
                    if (new_data[i] > stage.StageParameters[full_press_parameter_name].CurrentValue):
                        ...
                        if (press_counting_parameter_value != 1):
                            ...
                            is_nth_feed = PythonLeverIndividualPressStageImplementation.press_count % PythonLeverIndividualPressStageImplementation.nth_feed_parameter_value
                            if (is_nth_feed == 0):
